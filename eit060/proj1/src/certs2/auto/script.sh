...
openssl x509 -req -in server.csr -CA publickey.cer -CAkey privkey.pem -CAcreateserial -out servercert.cer < auto/data10
...
##10##
keytool -keystore servertruststore -importcert -file publickey.cer -alias servercert < auto/data13
