...
double measureTime(const NameServerInterface& ns,
	...
	for (int i = 0; i != nbrSearches; ++i) {
		...
		/*if (typeid(ns) == typeid(HNS)) {
			cout << address << " " << data[j].second << endl;
		}*/
...
int main() {
	...
	//int nbrSearches = 1000;
	//cin >> nbrSearches;
	double avgTime = measureTime(vns, data, 1000, seed);
	cout << "\tAverage search time (ms): " << avgTime << endl;
	
	cout << "Test map. Number of searches: ";
	//cin >> nbrSearches;
	avgTime = measureTime(mns, data, 1000000, seed);
	cout << "\t\tAverage search time (ms): " << avgTime << endl;
	
	cout << "Test unordered map. Number of searches: ";
	//cin >> nbrSearches;
	avgTime = measureTime(umns, data, 1000000, seed);
	cout << "Average search time (ms): " << avgTime << endl;
	
	cout << "Test hash. Number of searches: ";
	//cin >> nbrSearches;
	avgTime = measureTime(hns, data, 1000000, seed);
	cout << "\t\tAverage search time (ms): " << avgTime << endl;
}
