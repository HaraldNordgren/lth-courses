...
public class main {
	...
	private static void solve(Store store) {
		...
		IntVar[] starts0 = {job1[1], job2[4], job3[3], job4[1], job5[4], job6[3]};
		IntVar[] starts1 = {job1[2], job2[0], job3[4], job4[0], job5[1], job6[0]};
		IntVar[] starts2 = {job1[0], job2[1], job3[0], job4[2], job5[0], job6[5]};
		IntVar[] starts3 = {job1[3], job2[5], job3[1], job4[3], job5[5], job6[1]};
		IntVar[] starts4 = {job1[5], job2[2], job3[5], job4[4], job5[2], job6[4]};
		IntVar[] starts5 = {job1[4], job2[3], job3[2], job4[5], job5[3], job6[2]};



		IntVar limit = new IntVar(store, 1, 1);
		store.impose(new Cumulative(starts0, machineDuration0, machines, limit));
		store.impose(new Cumulative(starts1, machineDuration1, machines, limit));
		store.impose(new Cumulative(starts2, machineDuration2, machines, limit));
		store.impose(new Cumulative(starts3, machineDuration3, machines, limit));
		store.impose(new Cumulative(starts4, machineDuration4, machines, limit));
		store.impose(new Cumulative(starts5, machineDuration5, machines, limit));
