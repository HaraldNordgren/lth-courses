...
public class Burger2 extends ExampleFD {

    public IntVar[] x;

    public int n = 3; // number of ingredients
    public int m = 8; // number of food types

    public String[] food = {"Beef Patty", "Bun", "Cheese", "Onions",
    "Pickles","Lettuce", "Ketchup", "Tomato"};

    public String[] ingredients = {"Sodium (mg)", "Fat (g)", "Calories"};

    public int[] price   = {-25, -15, -10, -9, -3, -4, -2, -4}; // in cents
    public int[] limits  = {3000, 150, 3000};  // minimum required for a diet
	...
	public void model() {
        ...
        for(int i = 0; i < n; i++) {
            ...
            store.impose(new XltC(sums[i], limits[i]));
        }
    ...
    */
	...
	public static void printLastSolution(Burger2 diet) {
